...
redirect_stdio(stdout=log_file) do
    ...
    showtable(WB[1:2], LANGS, threshold=0.)
    showtable(WB[1:3], LANGS, threshold=0.)
    ...
    showtable(TB[1:2], LANGS, average=false)
    showtable(TB[1:3], LANGS, average=false)
